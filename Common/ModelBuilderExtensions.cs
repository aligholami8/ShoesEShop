...
namespace Common
{
    public static class ModelBuilderExtensions
    {
        ...
        //public static void AddSoftDelete<BaseType>(this ModelBuilder modelBuilder, params Assembly[] assemblies)
        //{
        //    IEnumerable<Type> types = assemblies.SelectMany(a => a.GetExportedTypes())
        //        .Where(c => c.IsClass && !c.IsAbstract && c.IsPublic && typeof(BaseType).IsAssignableFrom(c));

        //    foreach (Type type in types.Where(b => b.GetProperty("IsDeleted") != null))
        //        modelBuilder.Entity(type).HasQueryFilter(c => !);
        //}
    }
}
